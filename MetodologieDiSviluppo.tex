...
\begin{figure}[htpb!]
\center
  \includegraphics[width=0.2\textwidth]{Scrum}
  \caption{Scrum}
\end{figure}
...
\begin{figure}[htpb!]
\center
  \includegraphics[width=0.3\textwidth]{DialPoint}
...
\begin{figure}[htpb!]
\center
  \includegraphics[width=0.6\textwidth]{DialEsploso}
...
\begin{figure}[htpb!]
\center
  \includegraphics[width=0.6\textwidth]{LogoUWP}
